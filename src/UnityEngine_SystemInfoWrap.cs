...
public class UnityEngine_SystemInfoWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("processorFrequency", new LuaCSFunction(UnityEngine_SystemInfoWrap.get_processorFrequency), null);
		...
		L.RegVar("supportsRawShadowDepthSampling", new LuaCSFunction(UnityEngine_SystemInfoWrap.get_supportsRawShadowDepthSampling), null);
		...
		L.RegVar("supportsAudio", new LuaCSFunction(UnityEngine_SystemInfoWrap.get_supportsAudio), null);
