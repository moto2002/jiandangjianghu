...
[AddComponentMenu("Pathfinding/AI/AISimpleLerp (2D,3D generic)"), HelpURL("http://arongranberg.com/astar/docs/class_a_i_lerp.php"), RequireComponent(typeof(Seeker))]
public class AILerp : MonoBehaviour
{
	...
	protected virtual void OnEnable()
	{
		...
		if (this.startHasRun)
		{
			Seeker expr_23 = this.seeker;
			expr_23.pathCallback = (OnPathDelegate)Delegate.Combine(expr_23.pathCallback, new OnPathDelegate(this.OnPathComplete));
	...
	public void OnDisable()
	{
		...
		this.path = null;
		Seeker expr_56 = this.seeker;
		expr_56.pathCallback = (OnPathDelegate)Delegate.Remove(expr_56.pathCallback, new OnPathDelegate(this.OnPathComplete));
	}

	[DebuggerHidden]
	protected IEnumerator RepeatTrySearchPath()
	{
		AILerp.<RepeatTrySearchPath>c__Iterator2 <RepeatTrySearchPath>c__Iterator = new AILerp.<RepeatTrySearchPath>c__Iterator2();
