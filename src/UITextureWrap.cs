...
public class UITextureWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("Load", new LuaCSFunction(UITextureWrap.Load));
		L.RegFunction("LoadResources", new LuaCSFunction(UITextureWrap.LoadResources));
		L.RegFunction("OnFill", new LuaCSFunction(UITextureWrap.OnFill));
		L.RegFunction("HasActiveTexture", new LuaCSFunction(UITextureWrap.HasActiveTexture));
		L.RegFunction("__eq", new LuaCSFunction(UITextureWrap.op_Equality));
		L.RegFunction("__tostring", new LuaCSFunction(ToLua.op_ToString));
		L.RegVar("cacheTexture", new LuaCSFunction(UITextureWrap.get_cacheTexture), new LuaCSFunction(UITextureWrap.set_cacheTexture));
		L.RegVar("mainTexture", new LuaCSFunction(UITextureWrap.get_mainTexture), new LuaCSFunction(UITextureWrap.set_mainTexture));
		L.RegVar("baseTexture", new LuaCSFunction(UITextureWrap.get_baseTexture), new LuaCSFunction(UITextureWrap.set_baseTexture));
		L.RegVar("texturePath", new LuaCSFunction(UITextureWrap.get_texturePath), new LuaCSFunction(UITextureWrap.set_texturePath));
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int HasActiveTexture(IntPtr L)
	{
		int result;
		try
		{
			ToLua.CheckArgsCount(L, 1);
			string relativePath = ToLua.CheckString(L, 1);
			bool value = UITexture.HasActiveTexture(relativePath);
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int get_cacheTexture(IntPtr L)
	{
		object obj = null;
		int result;
		try
		{
			...
			Texture cacheTexture = uITexture.cacheTexture;
			ToLua.Push(L, cacheTexture);
			result = 1;
		}
		catch (Exception ex)
		{
			result = LuaDLL.toluaL_exception(L, ex, (obj != null) ? ex.Message : "attempt to index cacheTexture on a nil value");
		}
		return result;
	}
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int get_baseTexture(IntPtr L)
	{
		object obj = null;
		int result;
		try
		{
			obj = ToLua.ToObject(L, 1);
			UITexture uITexture = (UITexture)obj;
			Texture baseTexture = uITexture.baseTexture;
			ToLua.Push(L, baseTexture);
			result = 1;
		}
		catch (Exception ex)
		{
			result = LuaDLL.toluaL_exception(L, ex, (obj != null) ? ex.Message : "attempt to index baseTexture on a nil value");
		}
		return result;
	}

	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int get_texturePath(IntPtr L)
	{
		object obj = null;
		int result;
		try
		{
			obj = ToLua.ToObject(L, 1);
			UITexture uITexture = (UITexture)obj;
			string texturePath = uITexture.texturePath;
			LuaDLL.lua_pushstring(L, texturePath);
			result = 1;
		}
		catch (Exception ex)
		{
			result = LuaDLL.toluaL_exception(L, ex, (obj != null) ? ex.Message : "attempt to index texturePath on a nil value");
		}
		return result;
	}
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int set_cacheTexture(IntPtr L)
	{
		object obj = null;
		int result;
		try
		{
			obj = ToLua.ToObject(L, 1);
			UITexture uITexture = (UITexture)obj;
			Texture cacheTexture = (Texture)ToLua.CheckUnityObject(L, 2, typeof(Texture));
			uITexture.cacheTexture = cacheTexture;
			result = 0;
		}
		catch (Exception ex)
		{
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int set_baseTexture(IntPtr L)
	{
		object obj = null;
		int result;
		try
		{
			obj = ToLua.ToObject(L, 1);
			UITexture uITexture = (UITexture)obj;
			Texture baseTexture = (Texture)ToLua.CheckUnityObject(L, 2, typeof(Texture));
			uITexture.baseTexture = baseTexture;
			result = 0;
		}
		catch (Exception ex)
		{
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int set_texturePath(IntPtr L)
	{
		object obj = null;
		int result;
		try
		{
			obj = ToLua.ToObject(L, 1);
			UITexture uITexture = (UITexture)obj;
			string texturePath = ToLua.CheckString(L, 2);
			uITexture.texturePath = texturePath;
			result = 0;
		}
		catch (Exception ex)
		{
