...
[HelpURL("http://arongranberg.com/astar/docs/class_dynamic_grid_obstacle.php"), RequireComponent(typeof(Collider))]
public class DynamicGridObstacle : MonoBehaviour
{
	...
	{
		DynamicGridObstacle.<UpdateGraphs>c__Iterator14 <UpdateGraphs>c__Iterator = new DynamicGridObstacle.<UpdateGraphs>c__Iterator14();
