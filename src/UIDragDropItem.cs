...
public class UIDragDropItem : MonoBehaviour
{
	...
	{
		UIDragDropItem.<EnableDragScrollView>c__Iterator1A <EnableDragScrollView>c__Iterator1A = new UIDragDropItem.<EnableDragScrollView>c__Iterator1A();
		<EnableDragScrollView>c__Iterator1A.<>f__this = this;
		return <EnableDragScrollView>c__Iterator1A;
	}
}
