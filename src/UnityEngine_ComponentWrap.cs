...
public class UnityEngine_ComponentWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("DOTogglePause", new LuaCSFunction(UnityEngine_ComponentWrap.DOTogglePause));
		L.RegFunction("DOSmoothRewind", new LuaCSFunction(UnityEngine_ComponentWrap.DOSmoothRewind));
		L.RegFunction("DORewind", new LuaCSFunction(UnityEngine_ComponentWrap.DORewind));
		L.RegFunction("DORestart", new LuaCSFunction(UnityEngine_ComponentWrap.DORestart));
		L.RegFunction("DOPlayForward", new LuaCSFunction(UnityEngine_ComponentWrap.DOPlayForward));
		L.RegFunction("DOPlayBackwards", new LuaCSFunction(UnityEngine_ComponentWrap.DOPlayBackwards));
		L.RegFunction("DOPlay", new LuaCSFunction(UnityEngine_ComponentWrap.DOPlay));
		L.RegFunction("DOPause", new LuaCSFunction(UnityEngine_ComponentWrap.DOPause));
		L.RegFunction("DOGoto", new LuaCSFunction(UnityEngine_ComponentWrap.DOGoto));
		L.RegFunction("DOFlip", new LuaCSFunction(UnityEngine_ComponentWrap.DOFlip));
		L.RegFunction("DOKill", new LuaCSFunction(UnityEngine_ComponentWrap.DOKill));
		L.RegFunction("DOComplete", new LuaCSFunction(UnityEngine_ComponentWrap.DOComplete));
	...
	private static int DOTogglePause(IntPtr L)
	{
		...
		try
		{
			...
			Component target = (Component)ToLua.CheckObject(L, 1, typeof(Component));
