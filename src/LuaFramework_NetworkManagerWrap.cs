...
public class LuaFramework_NetworkManagerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("Init", new LuaCSFunction(LuaFramework_NetworkManagerWrap.Init));
		...
		L.RegFunction("Close", new LuaCSFunction(LuaFramework_NetworkManagerWrap.Close));
		...
		L.RegFunction("LostConnect", new LuaCSFunction(LuaFramework_NetworkManagerWrap.LostConnect));
		L.RegFunction("ResetConnect", new LuaCSFunction(LuaFramework_NetworkManagerWrap.ResetConnect));
		...
		L.RegVar("inReconnect", new LuaCSFunction(LuaFramework_NetworkManagerWrap.get_inReconnect), new LuaCSFunction(LuaFramework_NetworkManagerWrap.set_inReconnect));
		L.RegVar("lostConnect", new LuaCSFunction(LuaFramework_NetworkManagerWrap.get_lostConnect), null);
		L.EndClass();
	}
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int LostConnect(IntPtr L)
	{
		int result;
		try
		{
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int ResetConnect(IntPtr L)
	{
		int result;
		try
		{
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int get_inReconnect(IntPtr L)
	{
		object obj = null;
		int result;
		try
		{
			...
			bool inReconnect = networkManager.inReconnect;
			LuaDLL.lua_pushboolean(L, inReconnect);
			result = 1;
		}
		catch (Exception ex)
		{
			result = LuaDLL.toluaL_exception(L, ex, (obj != null) ? ex.Message : "attempt to index inReconnect on a nil value");
		}
		return result;
	}

	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int get_lostConnect(IntPtr L)
	{
		object obj = null;
		int result;
		try
		{
			obj = ToLua.ToObject(L, 1);
			NetworkManager networkManager = (NetworkManager)obj;
			bool lostConnect = networkManager.lostConnect;
			LuaDLL.lua_pushboolean(L, lostConnect);
			result = 1;
		}
		catch (Exception ex)
		{
			result = LuaDLL.toluaL_exception(L, ex, (obj != null) ? ex.Message : "attempt to index lostConnect on a nil value");
		}
		return result;
	}

	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int set_inReconnect(IntPtr L)
	{
		object obj = null;
		int result;
		try
		{
			obj = ToLua.ToObject(L, 1);
			NetworkManager networkManager = (NetworkManager)obj;
			bool inReconnect = LuaDLL.luaL_checkboolean(L, 2);
			networkManager.inReconnect = inReconnect;
			result = 0;
		}
		catch (Exception ex)
		{
