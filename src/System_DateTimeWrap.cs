...
public class System_DateTimeWrap
{
	...
	private static int _CreateSystem_DateTime(IntPtr L)
	{
		...
		try
		{
			...
			else if (num == 2 && TypeChecker.CheckTypes(L, 1, typeof(long), typeof(DateTimeKind)))
			{
				long ticks2 = LuaDLL.tolua_checkint64(L, 1);
				DateTimeKind kind = (DateTimeKind)((int)ToLua.CheckObject(L, 2, typeof(DateTimeKind)));
			...
			else if (num == 7 && TypeChecker.CheckTypes(L, 1, typeof(int), typeof(int), typeof(int), typeof(int), typeof(int), typeof(int), typeof(DateTimeKind)))
			{
				...
				DateTimeKind kind2 = (DateTimeKind)((int)ToLua.CheckObject(L, 7, typeof(DateTimeKind)));
			...
			else if (num == 8 && TypeChecker.CheckTypes(L, 1, typeof(int), typeof(int), typeof(int), typeof(int), typeof(int), typeof(int), typeof(int), typeof(DateTimeKind)))
			{
				...
				DateTimeKind kind3 = (DateTimeKind)((int)ToLua.CheckObject(L, 8, typeof(DateTimeKind)));
			...
			else if (num == 9 && TypeChecker.CheckTypes(L, 1, typeof(int), typeof(int), typeof(int), typeof(int), typeof(int), typeof(int), typeof(int), typeof(Calendar), typeof(DateTimeKind)))
			{
				...
				DateTimeKind kind4 = (DateTimeKind)((int)ToLua.CheckObject(L, 9, typeof(DateTimeKind)));
	...
	private static int Parse(IntPtr L)
	{
		...
		try
		{
			...
			else if (num == 3 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(IFormatProvider), typeof(DateTimeStyles)))
			{
				string s3 = ToLua.ToString(L, 1);
				IFormatProvider provider2 = (IFormatProvider)ToLua.ToObject(L, 2);
				DateTimeStyles styles = (DateTimeStyles)((int)ToLua.ToObject(L, 3));
	...
	private static int ParseExact(IntPtr L)
	{
		...
		try
		{
			...
			else if (num == 4 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(string[]), typeof(IFormatProvider), typeof(DateTimeStyles)))
			{
				string s2 = ToLua.ToString(L, 1);
				string[] formats = ToLua.CheckStringArray(L, 2);
				IFormatProvider provider2 = (IFormatProvider)ToLua.ToObject(L, 3);
				DateTimeStyles style = (DateTimeStyles)((int)ToLua.ToObject(L, 4));
			...
			else if (num == 4 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(string), typeof(IFormatProvider), typeof(DateTimeStyles)))
			{
				...
				DateTimeStyles style2 = (DateTimeStyles)((int)ToLua.ToObject(L, 4));
	...
	private static int TryParse(IntPtr L)
	{
		...
		try
		{
			...
			else if (num == 4 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(IFormatProvider), typeof(DateTimeStyles), typeof(LuaOut<DateTime>)))
			{
				string s2 = ToLua.ToString(L, 1);
				IFormatProvider provider = (IFormatProvider)ToLua.ToObject(L, 2);
				DateTimeStyles styles = (DateTimeStyles)((int)ToLua.ToObject(L, 3));
	...
	private static int TryParseExact(IntPtr L)
	{
		...
		{
			int num = LuaDLL.lua_gettop(L);
			if (num == 5 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(string[]), typeof(IFormatProvider), typeof(DateTimeStyles), typeof(LuaOut<DateTime>)))
			{
				string s = ToLua.ToString(L, 1);
				string[] formats = ToLua.CheckStringArray(L, 2);
				IFormatProvider provider = (IFormatProvider)ToLua.ToObject(L, 3);
			...
			else if (num == 5 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(string), typeof(IFormatProvider), typeof(DateTimeStyles), typeof(LuaOut<DateTime>)))
			{
				string s2 = ToLua.ToString(L, 1);
				string format = ToLua.ToString(L, 2);
				IFormatProvider provider2 = (IFormatProvider)ToLua.ToObject(L, 3);
