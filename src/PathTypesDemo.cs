...
public class PathTypesDemo : MonoBehaviour
{
	...
	{
		PathTypesDemo.<CalculateConstantPath>c__Iterator12 <CalculateConstantPath>c__Iterator = new PathTypesDemo.<CalculateConstantPath>c__Iterator12();
		<CalculateConstantPath>c__Iterator.<>f__this = this;
		return <CalculateConstantPath>c__Iterator;
	}
}
