...
public class FlyCam : MonoBehaviour
{
	...
	private void Update()
	{
		if (WaypointCam.waypoints.Length > 0)
		{
			...
			Quaternion b = Quaternion.LookRotation(a - base.transform.position);
			base.transform.rotation = Quaternion.Slerp(base.transform.rotation, b, Time.deltaTime * this.rotateSpeed);
