...
public class ProceduralGridMover : MonoBehaviour
{
	...
	{
		ProceduralGridMover.<UpdateGraphCoroutine>c__IteratorE <UpdateGraphCoroutine>c__IteratorE = new ProceduralGridMover.<UpdateGraphCoroutine>c__IteratorE();
		<UpdateGraphCoroutine>c__IteratorE.<>f__this = this;
		return <UpdateGraphCoroutine>c__IteratorE;
	}
}
