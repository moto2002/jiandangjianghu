...
namespace NSpeex
{
	internal class NbDecoder : NbCodec, IDecoder
	{
		...
		public int DecodeLost(float[] xout)
		{
			...
			float num2 = (this.pitch_gain_buf[0] >= this.pitch_gain_buf[1]) ? ((this.pitch_gain_buf[2] >= this.pitch_gain_buf[1]) ? ((this.pitch_gain_buf[2] >= this.pitch_gain_buf[0]) ? this.pitch_gain_buf[0] : this.pitch_gain_buf[2]) : this.pitch_gain_buf[1]) : ((this.pitch_gain_buf[1] >= this.pitch_gain_buf[2]) ? ((this.pitch_gain_buf[0] >= this.pitch_gain_buf[2]) ? this.pitch_gain_buf[0] : this.pitch_gain_buf[2]) : this.pitch_gain_buf[1]);
