...
[AddComponentMenu("Pathfinding/AI/AIFollow (deprecated)"), HelpURL("http://arongranberg.com/astar/docs/class_a_i_follow.php"), RequireComponent(typeof(Seeker)), RequireComponent(typeof(CharacterController))]
public class AIFollow : MonoBehaviour
{
	...
	{
		AIFollow.<WaitToRepath>c__Iterator13 <WaitToRepath>c__Iterator = new AIFollow.<WaitToRepath>c__Iterator13();
