...
public class T4MObjSC : MonoBehaviour
{
	...
	public void Awake()
	{
		if (this.Master == 1)
		{
			...
			if (this.enabledLayerCul)
			{
				...
				this.PlayerCamera.GetComponent<Camera>().layerCullDistances = this.distances;
			}
	...
	private void LateUpdate()
	{
		...
		if (this.PlayerCamera && !Application.isPlaying && this.Master == 1)
		{
			...
			{
				this.distances[26] = this.PlayerCamera.GetComponent<Camera>().farClipPlane;
				this.distances[27] = this.PlayerCamera.GetComponent<Camera>().farClipPlane;
				this.distances[28] = this.PlayerCamera.GetComponent<Camera>().farClipPlane;
				this.distances[29] = this.PlayerCamera.GetComponent<Camera>().farClipPlane;
				this.PlayerCamera.GetComponent<Camera>().layerCullDistances = this.distances;
			}
			if (this.LODPreview)
			{
