...
public class UIBasicSpriteWrap
{
	...
	private static int set_centerType(IntPtr L)
	{
		...
		try
		{
			obj = ToLua.ToObject(L, 1);
			UIBasicSprite uIBasicSprite = (UIBasicSprite)obj;
			UIBasicSprite.AdvancedType centerType = (UIBasicSprite.AdvancedType)((int)ToLua.CheckObject(L, 2, typeof(UIBasicSprite.AdvancedType)));
	...
	private static int set_leftType(IntPtr L)
	{
		...
		try
		{
			obj = ToLua.ToObject(L, 1);
			UIBasicSprite uIBasicSprite = (UIBasicSprite)obj;
			UIBasicSprite.AdvancedType leftType = (UIBasicSprite.AdvancedType)((int)ToLua.CheckObject(L, 2, typeof(UIBasicSprite.AdvancedType)));
	...
	private static int set_rightType(IntPtr L)
	{
		...
		try
		{
			obj = ToLua.ToObject(L, 1);
			UIBasicSprite uIBasicSprite = (UIBasicSprite)obj;
			UIBasicSprite.AdvancedType rightType = (UIBasicSprite.AdvancedType)((int)ToLua.CheckObject(L, 2, typeof(UIBasicSprite.AdvancedType)));
	...
	private static int set_bottomType(IntPtr L)
	{
		...
		try
		{
			obj = ToLua.ToObject(L, 1);
			UIBasicSprite uIBasicSprite = (UIBasicSprite)obj;
			UIBasicSprite.AdvancedType bottomType = (UIBasicSprite.AdvancedType)((int)ToLua.CheckObject(L, 2, typeof(UIBasicSprite.AdvancedType)));
