...
namespace Pathfinding
{
	public abstract class Path
	{
		...
		{
			Path.<WaitForPath>c__IteratorC <WaitForPath>c__IteratorC = new Path.<WaitForPath>c__IteratorC();
			<WaitForPath>c__IteratorC.<>f__this = this;
			return <WaitForPath>c__IteratorC;
		}
