...
namespace Pathfinding
{
	...
	public class RichAI : MonoBehaviour
	{
		...
		{
			RichAI.<SearchPaths>c__Iterator4 <SearchPaths>c__Iterator = new RichAI.<SearchPaths>c__Iterator4();
		...
		{
			RichAI.<TraverseSpecial>c__Iterator5 <TraverseSpecial>c__Iterator = new RichAI.<TraverseSpecial>c__Iterator5();
