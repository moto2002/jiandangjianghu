...
{
	[AddComponentMenu("Pathfinding/Modifiers/Raycast Simplifier"), HelpURL("http://arongranberg.com/astar/docs/class_pathfinding_1_1_raycast_modifier.php"), RequireComponent(typeof(Seeker))]
	[Serializable]
