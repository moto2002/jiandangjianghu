...
{
	[AddComponentMenu("Pathfinding/Modifiers/Simple Smooth"), HelpURL("http://arongranberg.com/astar/docs/class_pathfinding_1_1_simple_smooth_modifier.php"), RequireComponent(typeof(Seeker))]
	[Serializable]
