...
public class ProceduralWorld : MonoBehaviour
{
	...
	private class ProceduralTile
	{
		...
		{
			ProceduralWorld.ProceduralTile.<Generate>c__Iterator10 <Generate>c__Iterator = new ProceduralWorld.ProceduralTile.<Generate>c__Iterator10();
			<Generate>c__Iterator.<>f__this = this;
			return <Generate>c__Iterator;
		}
		...
		{
			ProceduralWorld.ProceduralTile.<InternalGenerate>c__Iterator11 <InternalGenerate>c__Iterator = new ProceduralWorld.ProceduralTile.<InternalGenerate>c__Iterator11();
			<InternalGenerate>c__Iterator.<>f__this = this;
			return <InternalGenerate>c__Iterator;
		}
	...
	{
		ProceduralWorld.<GenerateTiles>c__IteratorF <GenerateTiles>c__IteratorF = new ProceduralWorld.<GenerateTiles>c__IteratorF();
		<GenerateTiles>c__IteratorF.<>f__this = this;
		return <GenerateTiles>c__IteratorF;
	}
}
