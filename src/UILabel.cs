...
public class UILabel : UIWidget
{
	...
	private static bool isInitFix = false;
	...
	private void FixBokenWord(Font dynamicFont)
	{
		if (UILabel.isInitFix || dynamicFont == null)
		{
			return;
		}
		UILabel.isInitFix = true;
		TextAsset textAsset = Resources.Load<TextAsset>("commonCharacter2000");
		dynamicFont.RequestCharactersInTexture(textAsset.text);
		Texture mainTexture = dynamicFont.material.mainTexture;
