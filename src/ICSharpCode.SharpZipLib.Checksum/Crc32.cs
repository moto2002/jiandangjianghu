...
namespace ICSharpCode.SharpZipLib.Checksum
{
	...
	{
		private static readonly uint crcInit = 4294967295u;

		private static readonly uint crcXor = 4294967295u;
		...
		{
			return Crc32.crcTable[(int)((UIntPtr)((oldCrc ^ (uint)bval) & 255u))] ^ oldCrc >> 8;
		}
