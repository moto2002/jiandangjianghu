		...
		public override int Read(byte[] buffer, int offset, int count)
		{
			...
			while (i < count)
			{
				...
				if (num < this._blockAndAuth)
				{
					...
					{
						int num5 = num - 10;
						this._transform.TransformBlock(this._slideBuffer, this._slideBufStartPos, num5, buffer, offset);
						i += num5;
				...
				this._transform.TransformBlock(this._slideBuffer, this._slideBufStartPos, 16, buffer, offset);
				i += 16;
				offset += 16;
