...
public class UnityEngine_RenderTextureWrap
{
	...
	private static int _CreateUnityEngine_RenderTexture(IntPtr L)
	{
		...
		try
		{
			...
			else if (num == 4 && TypeChecker.CheckTypes(L, 1, typeof(int), typeof(int), typeof(int), typeof(RenderTextureFormat)))
			{
				...
				RenderTextureFormat format = (RenderTextureFormat)((int)ToLua.CheckObject(L, 4, typeof(RenderTextureFormat)));
			...
			else if (num == 5 && TypeChecker.CheckTypes(L, 1, typeof(int), typeof(int), typeof(int), typeof(RenderTextureFormat), typeof(RenderTextureReadWrite)))
			{
				...
				RenderTextureFormat format2 = (RenderTextureFormat)((int)ToLua.CheckObject(L, 4, typeof(RenderTextureFormat)));
				RenderTextureReadWrite readWrite = (RenderTextureReadWrite)((int)ToLua.CheckObject(L, 5, typeof(RenderTextureReadWrite)));
	...
	private static int GetTemporary(IntPtr L)
	{
		...
		try
		{
			...
			else if (num == 4 && TypeChecker.CheckTypes(L, 1, typeof(int), typeof(int), typeof(int), typeof(RenderTextureFormat)))
			{
				...
				RenderTextureFormat format = (RenderTextureFormat)((int)ToLua.ToObject(L, 4));
			...
			else if (num == 5 && TypeChecker.CheckTypes(L, 1, typeof(int), typeof(int), typeof(int), typeof(RenderTextureFormat), typeof(RenderTextureReadWrite)))
			{
				...
				RenderTextureFormat format2 = (RenderTextureFormat)((int)ToLua.ToObject(L, 4));
				RenderTextureReadWrite readWrite = (RenderTextureReadWrite)((int)ToLua.ToObject(L, 5));
			...
			else if (num == 6 && TypeChecker.CheckTypes(L, 1, typeof(int), typeof(int), typeof(int), typeof(RenderTextureFormat), typeof(RenderTextureReadWrite), typeof(int)))
			{
				...
				RenderTextureFormat format3 = (RenderTextureFormat)((int)ToLua.ToObject(L, 4));
				RenderTextureReadWrite readWrite2 = (RenderTextureReadWrite)((int)ToLua.ToObject(L, 5));
	...
	private static int set_format(IntPtr L)
	{
		...
		try
		{
			obj = ToLua.ToObject(L, 1);
			RenderTexture renderTexture = (RenderTexture)obj;
			RenderTextureFormat format = (RenderTextureFormat)((int)ToLua.CheckObject(L, 2, typeof(RenderTextureFormat)));
