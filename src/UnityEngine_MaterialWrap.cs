...
public class UnityEngine_MaterialWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("DOTogglePause", new LuaCSFunction(UnityEngine_MaterialWrap.DOTogglePause));
		L.RegFunction("DOSmoothRewind", new LuaCSFunction(UnityEngine_MaterialWrap.DOSmoothRewind));
		L.RegFunction("DORewind", new LuaCSFunction(UnityEngine_MaterialWrap.DORewind));
		L.RegFunction("DORestart", new LuaCSFunction(UnityEngine_MaterialWrap.DORestart));
		L.RegFunction("DOPlayForward", new LuaCSFunction(UnityEngine_MaterialWrap.DOPlayForward));
		L.RegFunction("DOPlayBackwards", new LuaCSFunction(UnityEngine_MaterialWrap.DOPlayBackwards));
		L.RegFunction("DOPlay", new LuaCSFunction(UnityEngine_MaterialWrap.DOPlay));
		L.RegFunction("DOPause", new LuaCSFunction(UnityEngine_MaterialWrap.DOPause));
		L.RegFunction("DOGoto", new LuaCSFunction(UnityEngine_MaterialWrap.DOGoto));
		L.RegFunction("DOFlip", new LuaCSFunction(UnityEngine_MaterialWrap.DOFlip));
		L.RegFunction("DOKill", new LuaCSFunction(UnityEngine_MaterialWrap.DOKill));
		L.RegFunction("DOComplete", new LuaCSFunction(UnityEngine_MaterialWrap.DOComplete));
		L.RegFunction("DOBlendableColor", new LuaCSFunction(UnityEngine_MaterialWrap.DOBlendableColor));
		L.RegFunction("DOVector", new LuaCSFunction(UnityEngine_MaterialWrap.DOVector));
		L.RegFunction("DOTiling", new LuaCSFunction(UnityEngine_MaterialWrap.DOTiling));
		L.RegFunction("DOOffset", new LuaCSFunction(UnityEngine_MaterialWrap.DOOffset));
		L.RegFunction("DOFloat", new LuaCSFunction(UnityEngine_MaterialWrap.DOFloat));
		L.RegFunction("DOFade", new LuaCSFunction(UnityEngine_MaterialWrap.DOFade));
		L.RegFunction("DOColor", new LuaCSFunction(UnityEngine_MaterialWrap.DOColor));
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DOTogglePause(IntPtr L)
	{
		int result;
		try
		{
			ToLua.CheckArgsCount(L, 1);
			Material target = (Material)ToLua.CheckObject(L, 1, typeof(Material));
			int n = target.DOTogglePause();
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DOSmoothRewind(IntPtr L)
	{
		int result;
		try
		{
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DORewind(IntPtr L)
	{
		int result;
		try
		{
			...
			int n = target.DORewind(includeDelay);
			LuaDLL.lua_pushinteger(L, n);
			result = 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DORestart(IntPtr L)
	{
		int result;
		try
		{
			...
			Material target = (Material)ToLua.CheckObject(L, 1, typeof(Material));
			bool includeDelay = LuaDLL.luaL_checkboolean(L, 2);
			int n = target.DORestart(includeDelay);
			LuaDLL.lua_pushinteger(L, n);
			result = 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DOPlayForward(IntPtr L)
	{
		int result;
		try
		{
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DOPlayBackwards(IntPtr L)
	{
		int result;
		try
		{
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DOPlay(IntPtr L)
	{
		int result;
		try
		{
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DOPause(IntPtr L)
	{
		int result;
		try
		{
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DOGoto(IntPtr L)
	{
		int result;
		try
		{
			...
			int n = target.DOGoto(to, andPlay);
			LuaDLL.lua_pushinteger(L, n);
			result = 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DOFlip(IntPtr L)
	{
		int result;
		try
		{
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DOComplete(IntPtr L)
	{
		int result;
		try
		{
			...
			int n = target.DOComplete(withCallbacks);
			LuaDLL.lua_pushinteger(L, n);
			result = 1;
		}
		catch (Exception e)
	...
	private static int DOBlendableColor(IntPtr L)
	{
		...
		{
			int num = LuaDLL.lua_gettop(L);
			if (num == 3 && TypeChecker.CheckTypes(L, 1, typeof(Material), typeof(Color), typeof(float)))
			{
				Material target = (Material)ToLua.ToObject(L, 1);
			...
			else if (num == 4 && TypeChecker.CheckTypes(L, 1, typeof(Material), typeof(Color), typeof(string), typeof(float)))
			{
				Material target2 = (Material)ToLua.ToObject(L, 1);
				Color endValue2 = ToLua.ToColor(L, 2);
				string property = ToLua.ToString(L, 3);
				float duration2 = (float)LuaDLL.lua_tonumber(L, 4);
				Tweener o2 = target2.DOBlendableColor(endValue2, property, duration2);
				ToLua.PushObject(L, o2);
				result = 1;
			}
			else
			{
				result = LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.Material.DOBlendableColor");
			}
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DOVector(IntPtr L)
	{
		int result;
		try
		{
			ToLua.CheckArgsCount(L, 4);
			Material target = (Material)ToLua.CheckObject(L, 1, typeof(Material));
			Vector4 endValue = ToLua.ToVector4(L, 2);
			string property = ToLua.CheckString(L, 3);
			float duration = (float)LuaDLL.luaL_checknumber(L, 4);
			Tweener o = target.DOVector(endValue, property, duration);
			ToLua.PushObject(L, o);
			result = 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DOTiling(IntPtr L)
	{
		int result;
		try
		{
			int num = LuaDLL.lua_gettop(L);
			if (num == 3 && TypeChecker.CheckTypes(L, 1, typeof(Material), typeof(Vector2), typeof(float)))
			{
				Material target = (Material)ToLua.ToObject(L, 1);
				Vector2 endValue = ToLua.ToVector2(L, 2);
				float duration = (float)LuaDLL.lua_tonumber(L, 3);
				Tweener o = target.DOTiling(endValue, duration);
				ToLua.PushObject(L, o);
				result = 1;
			}
			else if (num == 4 && TypeChecker.CheckTypes(L, 1, typeof(Material), typeof(Vector2), typeof(string), typeof(float)))
			{
				Material target2 = (Material)ToLua.ToObject(L, 1);
				Vector2 endValue2 = ToLua.ToVector2(L, 2);
				string property = ToLua.ToString(L, 3);
				float duration2 = (float)LuaDLL.lua_tonumber(L, 4);
				Tweener o2 = target2.DOTiling(endValue2, property, duration2);
				ToLua.PushObject(L, o2);
				result = 1;
			}
			else
			{
				result = LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.Material.DOTiling");
			}
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DOOffset(IntPtr L)
	{
		int result;
		try
		{
			...
			if (num == 3 && TypeChecker.CheckTypes(L, 1, typeof(Material), typeof(Vector2), typeof(float)))
			{
				...
				Vector2 endValue = ToLua.ToVector2(L, 2);
				float duration = (float)LuaDLL.lua_tonumber(L, 3);
				Tweener o = target.DOOffset(endValue, duration);
				ToLua.PushObject(L, o);
				result = 1;
			}
			else if (num == 4 && TypeChecker.CheckTypes(L, 1, typeof(Material), typeof(Vector2), typeof(string), typeof(float)))
			{
				...
				string property = ToLua.ToString(L, 3);
				float duration2 = (float)LuaDLL.lua_tonumber(L, 4);
				Tweener o2 = target2.DOOffset(endValue2, property, duration2);
				ToLua.PushObject(L, o2);
				result = 1;
			}
			else
			{
				result = LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.Material.DOOffset");
			}
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DOFloat(IntPtr L)
	{
		int result;
		try
		{
			...
			string property = ToLua.CheckString(L, 3);
			float duration = (float)LuaDLL.luaL_checknumber(L, 4);
			Tweener o = target.DOFloat(endValue, property, duration);
			ToLua.PushObject(L, o);
			result = 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DOFade(IntPtr L)
	{
		int result;
		try
		{
			int num = LuaDLL.lua_gettop(L);
			if (num == 3 && TypeChecker.CheckTypes(L, 1, typeof(Material), typeof(float), typeof(float)))
			{
				Material target = (Material)ToLua.ToObject(L, 1);
				float endValue = (float)LuaDLL.lua_tonumber(L, 2);
				float duration = (float)LuaDLL.lua_tonumber(L, 3);
				Tweener o = target.DOFade(endValue, duration);
				ToLua.PushObject(L, o);
				result = 1;
			}
			else if (num == 4 && TypeChecker.CheckTypes(L, 1, typeof(Material), typeof(float), typeof(string), typeof(float)))
			{
				Material target2 = (Material)ToLua.ToObject(L, 1);
				float endValue2 = (float)LuaDLL.lua_tonumber(L, 2);
				string property = ToLua.ToString(L, 3);
				float duration2 = (float)LuaDLL.lua_tonumber(L, 4);
				Tweener o2 = target2.DOFade(endValue2, property, duration2);
				ToLua.PushObject(L, o2);
				result = 1;
			}
			else
			{
				result = LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.Material.DOFade");
			}
		}
		catch (Exception e)
		{
	...
	private static int DOColor(IntPtr L)
	{
		...
		try
		{
			...
			else if (num == 4 && TypeChecker.CheckTypes(L, 1, typeof(Material), typeof(Color), typeof(string), typeof(float)))
			{
				...
				string property = ToLua.ToString(L, 3);
				float duration2 = (float)LuaDLL.lua_tonumber(L, 4);
				Tweener o2 = target2.DOColor(endValue2, property, duration2);
				ToLua.PushObject(L, o2);
				result = 1;
			}
			else
			{
				result = LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.Material.DOColor");
			}
		}
		catch (Exception e)
		{
