	...
	public class BZip2OutputStream : Stream
	{
				...
				for (m = 0; m < this.nMTF; m = num7 + 1)
				{
					...
					else
					{
						for (int num23 = m; num23 <= num7; num23++)
						{
							...
							{
								short[] expr_378_cp_0 = array4;
								int expr_378_cp_1 = num25;
								expr_378_cp_0[expr_378_cp_1] += (short)array[num25][(int)num24];
							}
						}
					}
					int num26 = 999999999;
		...
		private void RandomiseBlock()
		{
			...
			for (int i = 0; i <= this.last; i++)
			{
				...
				num--;
				byte[] expr_5B_cp_0 = this.block;
				int expr_5B_cp_1 = i + 1;
				expr_5B_cp_0[expr_5B_cp_1] ^= ((num != 1) ? 0 : 1);
				byte[] expr_7D_cp_0 = this.block;
				int expr_7D_cp_1 = i + 1;
				expr_7D_cp_0[expr_7D_cp_1] &= 255;
