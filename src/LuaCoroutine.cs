...
public static class LuaCoroutine
{
	...
	{
		LuaCoroutine.<CoWaitForSeconds>c__Iterator2A <CoWaitForSeconds>c__Iterator2A = new LuaCoroutine.<CoWaitForSeconds>c__Iterator2A();
		<CoWaitForSeconds>c__Iterator2A.sec = sec;
		<CoWaitForSeconds>c__Iterator2A.func = func;
		<CoWaitForSeconds>c__Iterator2A.<$>sec = sec;
		<CoWaitForSeconds>c__Iterator2A.<$>func = func;
		return <CoWaitForSeconds>c__Iterator2A;
	}
	...
	{
		LuaCoroutine.<CoWaitForFixedUpdate>c__Iterator2B <CoWaitForFixedUpdate>c__Iterator2B = new LuaCoroutine.<CoWaitForFixedUpdate>c__Iterator2B();
		<CoWaitForFixedUpdate>c__Iterator2B.func = func;
		<CoWaitForFixedUpdate>c__Iterator2B.<$>func = func;
		return <CoWaitForFixedUpdate>c__Iterator2B;
	}
	...
	{
		LuaCoroutine.<CoWaitForEndOfFrame>c__Iterator2C <CoWaitForEndOfFrame>c__Iterator2C = new LuaCoroutine.<CoWaitForEndOfFrame>c__Iterator2C();
		<CoWaitForEndOfFrame>c__Iterator2C.func = func;
		<CoWaitForEndOfFrame>c__Iterator2C.<$>func = func;
		return <CoWaitForEndOfFrame>c__Iterator2C;
	}
	...
	{
		LuaCoroutine.<CoYield>c__Iterator2D <CoYield>c__Iterator2D = new LuaCoroutine.<CoYield>c__Iterator2D();
		<CoYield>c__Iterator2D.o = o;
		<CoYield>c__Iterator2D.func = func;
		<CoYield>c__Iterator2D.<$>o = o;
		<CoYield>c__Iterator2D.<$>func = func;
		return <CoYield>c__Iterator2D;
	}
