...
public class UIPopupList : UIWidgetContainer
{
	...
	{
		UIPopupList.<UpdateTweenPosition>c__Iterator1B <UpdateTweenPosition>c__Iterator1B = new UIPopupList.<UpdateTweenPosition>c__Iterator1B();
		<UpdateTweenPosition>c__Iterator1B.<>f__this = this;
		return <UpdateTweenPosition>c__Iterator1B;
	}
	...
	{
		UIPopupList.<CloseIfUnselected>c__Iterator1C <CloseIfUnselected>c__Iterator1C = new UIPopupList.<CloseIfUnselected>c__Iterator1C();
		<CloseIfUnselected>c__Iterator1C.<>f__this = this;
		return <CloseIfUnselected>c__Iterator1C;
	}
