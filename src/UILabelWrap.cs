...
public class UILabelWrap
{
	...
	private static int GetCharacterIndex(IntPtr L)
	{
		...
		try
		{
			...
			KeyCode key = (KeyCode)((int)ToLua.CheckObject(L, 3, typeof(KeyCode)));
	...
	private static int set_keepCrispWhenShrunk(IntPtr L)
	{
		...
		try
		{
			obj = ToLua.ToObject(L, 1);
			UILabel uILabel = (UILabel)obj;
			UILabel.Crispness keepCrispWhenShrunk = (UILabel.Crispness)((int)ToLua.CheckObject(L, 2, typeof(UILabel.Crispness)));
	...
	private static int set_overflowMethod(IntPtr L)
	{
		...
		try
		{
			obj = ToLua.ToObject(L, 1);
			UILabel uILabel = (UILabel)obj;
			UILabel.Overflow overflowMethod = (UILabel.Overflow)((int)ToLua.CheckObject(L, 2, typeof(UILabel.Overflow)));
	...
	private static int set_effectStyle(IntPtr L)
	{
		...
		try
		{
			obj = ToLua.ToObject(L, 1);
			UILabel uILabel = (UILabel)obj;
			UILabel.Effect effectStyle = (UILabel.Effect)((int)ToLua.CheckObject(L, 2, typeof(UILabel.Effect)));
