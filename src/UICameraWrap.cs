...
public class UICameraWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetMouse", new LuaCSFunction(UICameraWrap.GetMouse));
		L.RegFunction("GetTouch", new LuaCSFunction(UICameraWrap.GetTouch));
		L.RegFunction("RemoveTouch", new LuaCSFunction(UICameraWrap.RemoveTouch));
		...
		L.RegVar("lastTouchPosition", new LuaCSFunction(UICameraWrap.get_lastTouchPosition), new LuaCSFunction(UICameraWrap.set_lastTouchPosition));
		...
		L.RegVar("inputHasFocus", new LuaCSFunction(UICameraWrap.get_inputHasFocus), new LuaCSFunction(UICameraWrap.set_inputHasFocus));
	...
	private static int set_eventType(IntPtr L)
	{
		...
		try
		{
			obj = ToLua.ToObject(L, 1);
			UICamera uICamera = (UICamera)obj;
			UICamera.EventType eventType = (UICamera.EventType)((int)ToLua.CheckObject(L, 2, typeof(UICamera.EventType)));
	...
	private static int set_submitKey0(IntPtr L)
	{
		...
		try
		{
			obj = ToLua.ToObject(L, 1);
			UICamera uICamera = (UICamera)obj;
			KeyCode submitKey = (KeyCode)((int)ToLua.CheckObject(L, 2, typeof(KeyCode)));
	...
	private static int set_cancelKey0(IntPtr L)
	{
		...
		try
		{
			obj = ToLua.ToObject(L, 1);
			UICamera uICamera = (UICamera)obj;
			KeyCode cancelKey = (KeyCode)((int)ToLua.CheckObject(L, 2, typeof(KeyCode)));
	...
	private static int set_lastTouchPosition(IntPtr L)
	{
		...
		try
		{
			Vector2 lastTouchPosition = ToLua.ToVector2(L, 2);
	...
	private static int set_currentScheme(IntPtr L)
	{
		...
		try
		{
			UICamera.ControlScheme currentScheme = (UICamera.ControlScheme)((int)ToLua.CheckObject(L, 2, typeof(UICamera.ControlScheme)));
	...
	private static int set_currentKey(IntPtr L)
	{
		...
		try
		{
			KeyCode currentKey = (KeyCode)((int)ToLua.CheckObject(L, 2, typeof(KeyCode)));
	...
	private static int set_inputHasFocus(IntPtr L)
	{
		...
		try
		{
			bool inputHasFocus = LuaDLL.luaL_checkboolean(L, 2);
			UICamera.inputHasFocus = inputHasFocus;
			result = 0;
		}
		catch (Exception e)
		{
