...
namespace Pathfinding.Voxels
{
	public class Voxelize
	{
		...
		public void VoxelizeInput()
		{
			...
			Matrix4x4 lhs = Matrix4x4.TRS(-new Vector3(0.5f, 0f, 0.5f), Quaternion.identity, Vector3.one) * Matrix4x4.Scale(new Vector3(num, num2, num)) * Matrix4x4.TRS(-min, Quaternion.identity, Vector3.one);
			for (int j = 0; j < this.inputExtraMeshes.Count; j++)
			{
				...
				{
					Matrix4x4 matrix4x = extraMesh.matrix;
