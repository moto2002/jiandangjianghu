...
public class UnityEngine_CameraWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("DOShakeRotation", new LuaCSFunction(UnityEngine_CameraWrap.DOShakeRotation));
		L.RegFunction("DOShakePosition", new LuaCSFunction(UnityEngine_CameraWrap.DOShakePosition));
		L.RegFunction("DORect", new LuaCSFunction(UnityEngine_CameraWrap.DORect));
		L.RegFunction("DOPixelRect", new LuaCSFunction(UnityEngine_CameraWrap.DOPixelRect));
		L.RegFunction("DOOrthoSize", new LuaCSFunction(UnityEngine_CameraWrap.DOOrthoSize));
		L.RegFunction("DONearClipPlane", new LuaCSFunction(UnityEngine_CameraWrap.DONearClipPlane));
		L.RegFunction("DOFieldOfView", new LuaCSFunction(UnityEngine_CameraWrap.DOFieldOfView));
		L.RegFunction("DOFarClipPlane", new LuaCSFunction(UnityEngine_CameraWrap.DOFarClipPlane));
		L.RegFunction("DOColor", new LuaCSFunction(UnityEngine_CameraWrap.DOColor));
		L.RegFunction("DOAspect", new LuaCSFunction(UnityEngine_CameraWrap.DOAspect));
	...
	private static int DOShakeRotation(IntPtr L)
	{
		...
		{
			int num = LuaDLL.lua_gettop(L);
			if (num == 6 && TypeChecker.CheckTypes(L, 1, typeof(Camera), typeof(float), typeof(float), typeof(int), typeof(float), typeof(bool)))
			{
				Camera target = (Camera)ToLua.ToObject(L, 1);
			...
			else if (num == 6 && TypeChecker.CheckTypes(L, 1, typeof(Camera), typeof(float), typeof(Vector3), typeof(int), typeof(float), typeof(bool)))
			{
				Camera target2 = (Camera)ToLua.ToObject(L, 1);
			...
			{
				result = LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.Camera.DOShakeRotation");
			}
		}
		catch (Exception e)
		{
	...
	private static int DOShakePosition(IntPtr L)
	{
		...
		try
		{
			...
			else if (num == 6 && TypeChecker.CheckTypes(L, 1, typeof(Camera), typeof(float), typeof(Vector3), typeof(int), typeof(float), typeof(bool)))
			{
				...
				float randomness2 = (float)LuaDLL.lua_tonumber(L, 5);
				bool fadeOut2 = LuaDLL.lua_toboolean(L, 6);
				Tweener o2 = target2.DOShakePosition(duration2, strength2, vibrato2, randomness2, fadeOut2);
				ToLua.PushObject(L, o2);
				result = 1;
			}
			else
			{
				result = LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.Camera.DOShakePosition");
			}
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DORect(IntPtr L)
	{
		int result;
		try
		{
			ToLua.CheckArgsCount(L, 3);
			Camera target = (Camera)ToLua.CheckObject(L, 1, typeof(Camera));
			Rect endValue = (Rect)ToLua.CheckObject(L, 2, typeof(Rect));
			float duration = (float)LuaDLL.luaL_checknumber(L, 3);
			Tweener o = target.DORect(endValue, duration);
			ToLua.PushObject(L, o);
			result = 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DOPixelRect(IntPtr L)
	{
		int result;
		try
		{
			...
			Rect endValue = (Rect)ToLua.CheckObject(L, 2, typeof(Rect));
			float duration = (float)LuaDLL.luaL_checknumber(L, 3);
			Tweener o = target.DOPixelRect(endValue, duration);
			ToLua.PushObject(L, o);
			result = 1;
		}
		catch (Exception e)
	...
	private static int DOOrthoSize(IntPtr L)
	{
		...
		try
		{
			...
			float duration = (float)LuaDLL.luaL_checknumber(L, 3);
			Tweener o = target.DOOrthoSize(endValue, duration);
			ToLua.PushObject(L, o);
			result = 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DONearClipPlane(IntPtr L)
	{
		int result;
		try
		{
			...
			float endValue = (float)LuaDLL.luaL_checknumber(L, 2);
			float duration = (float)LuaDLL.luaL_checknumber(L, 3);
			Tweener o = target.DONearClipPlane(endValue, duration);
			ToLua.PushObject(L, o);
			result = 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DOFieldOfView(IntPtr L)
	{
		int result;
		try
		{
			...
			float endValue = (float)LuaDLL.luaL_checknumber(L, 2);
			float duration = (float)LuaDLL.luaL_checknumber(L, 3);
			Tweener o = target.DOFieldOfView(endValue, duration);
			ToLua.PushObject(L, o);
			result = 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DOFarClipPlane(IntPtr L)
	{
		int result;
		try
		{
			...
			float endValue = (float)LuaDLL.luaL_checknumber(L, 2);
			float duration = (float)LuaDLL.luaL_checknumber(L, 3);
			Tweener o = target.DOFarClipPlane(endValue, duration);
			ToLua.PushObject(L, o);
			result = 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DOAspect(IntPtr L)
	{
		int result;
		try
		{
			...
			float endValue = (float)LuaDLL.luaL_checknumber(L, 2);
			float duration = (float)LuaDLL.luaL_checknumber(L, 3);
			Tweener o = target.DOAspect(endValue, duration);
			ToLua.PushObject(L, o);
			result = 1;
		}
		catch (Exception e)
