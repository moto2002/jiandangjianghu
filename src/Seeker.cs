...
[AddComponentMenu("Pathfinding/Seeker"), HelpURL("http://arongranberg.com/astar/docs/class_seeker.php")]
public class Seeker : MonoBehaviour, ISerializationCallbackReceiver
{
	...
	[HideInInspector, FormerlySerializedAs("traversableTags"), SerializeField]
